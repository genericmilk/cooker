    ...
    public function handle(){
		...
		if(!config('cooker.silent')){
			...
			if(count($t_ok)){
				...
				if($this->option('verbose')){
					$this->table(['Job', 'Oven', 'Output'],$t_ok);
				}else{
					$this->table(['Job', 'Output'],$t_ok);
				}
			...
			if(count($t_failed)){
				...
				$this->table(['Job', 'Exception'],$t_failed);
			...
			$this->notify((count($t_failed)>0 ? '❌ Cook Failed' : '✅ Cooked OK') ,'Took '.$time_elapsed_secs.'s',__DIR__.'/../../cooker.png');
		}
    }
